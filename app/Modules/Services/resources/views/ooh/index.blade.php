                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-2 offset-4">
                            <form action={{ url("services/out-of-home/form") }} method="get">
                                <button type="submit" class="btn btn-block btn-outline-secondary btn"><i class="fas fa-plus"></i> Create Out Of Home</button>
                            </form>
                        </div>
                    </div>
                </div>
