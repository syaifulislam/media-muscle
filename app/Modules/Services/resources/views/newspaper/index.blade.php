                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-2 offset-4">
                            <form action={{ url("services/newspaper/form") }} method="get">
                                <button type="submit" class="btn btn-block btn-outline-secondary btn"><i class="fas fa-plus"></i> Create Newspaper</button>
                            </form>
                        </div>
                    </div>
                </div>
